...
- **Code**: fix bugs, add features, improve performance — see [Contributing](contributing.md)
- **Translation**: add or improve language support in `api/locales/` and `web/public/locales/`
- **Documentation**: improve these docs for future readers
